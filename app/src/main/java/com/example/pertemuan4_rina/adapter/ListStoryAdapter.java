package com.example.pertemuan4_rina.adapter;
...
import com.example.pertemuan4_rina.R;
import com.example.pertemuan4_rina.model.Story;
import com.example.pertemuan4_rina.ui.DetailCeritaActivity;
import com.example.pertemuan4_rina.util.Constans;
...
public class ListStoryAdapter extends RecyclerView.Adapter<ListStoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context)
                .load(story.getImage())
                .placeholder(R.drawable.bc) // Placeholder jika gambar gagal dimuat
